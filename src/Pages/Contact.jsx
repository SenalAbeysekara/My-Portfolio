...
const ContactPage = () => {
  ...
  try {
    // Existing FormSubmit logic to send an email to Gmail
    const formSubmitUrl = 'https://formsubmit.co/840347ddf9e6351b01198c8306d9c59e';
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                ...
                <div className="space-y-3">
                  <p className="text-gray-300 flex items-center">
                    <Mail className="w-5 h-5 mr-3 text-[#6366f1]" />
                    senaldushyantha@gmail.com
                  </p>
                </div>
              </div>
